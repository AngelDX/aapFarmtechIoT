<div class="mb-6 m-2 bg-white overflow-hidden shadow-xl sm:rounded-lg">
    <div id="container"></div>
</div>
<div id="container2" class="m-2 bg-white overflow-hidden shadow-xl sm:rounded-lg">
    <div id="loading">
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        title: { text: 'Cantidad de sensores registrados' },
        subtitle: {
            text: ''
        },
         xAxis: {
...
Meteogram.prototype.getChartOptions = function () {
  return {
    ...
    title: {
      text: 'Diagrama metereologico de la región Puno',
      align: 'left',
      style: {
        whiteSpace: 'nowrap',
